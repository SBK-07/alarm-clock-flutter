...
class _AlarmPageState extends State<AlarmPage> {
  ...
  void scheduleAlarm(DateTime scheduledNotificationDateTime, AlarmInfo alarmInfo, {required bool isRepeating}) async {
    ...
    // iOS notification details - removed soundName parameter
    final DarwinNotificationDetails darwinDetails = DarwinNotificationDetails(
      presentAlert: true,
      presentBadge: true,
      presentSound: true,
      // Simply use a string for the sound file name
    ...
    if (Platform.isAndroid) {
      ...
      platformChannelSpecifics = NotificationDetails(iOS: darwinDetails, macOS: darwinDetails);
    ...
    // Get the TZDateTime for the scheduled alarm
    tz.TZDateTime scheduledDate = tz.TZDateTime.from(scheduledNotificationDateTime, tz.local);
    ...
    if (isRepeating) {
      ...
      await flutterLocalNotificationsPlugin.zonedSchedule(
        ...
        // Add the required androidScheduleMode parameter
